...
We are highly confident that r₁ was an approximant because it tends to lengthen preceding vowels (/ar₁/ ${\rightarrow}$ /aː/), open following vowels (/r₁i/ ${\rightarrow}$ /e/), and extend voicing into following consonants (/r₁t/ ${\rightarrow}$ /d/). This sound is sometimes represented in romanization as \<~> to reflect these functions.
...
We are confident that r₂ is a back sound because it tends to round adjoining vowels on either side (/ar₂/ ${\rightarrow}$ /ɶ/, /r₂i/ ${\rightarrow}$ /y/), and that it involved a high degree of stopping because it tends to leave glottal stops between vowels and unpredictable stops after other consonants (/ar₂i/ ${\rightarrow}$ /ɶʔi/, /ʃr₂/ ${\rightarrow}$ /ʃk/, /ʃt/). This sound is sometimes represented as \<•> in romanization to reflect the syllable-breaking effect of this sound.
